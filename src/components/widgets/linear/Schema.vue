    ...
    <div class="row">
      ...
      >
        <div class="row q-pa-sm">
          ...
          <div class="col-12">
            <q-input outlined hide-bottom-space v-if="currentSettings.minValueMode === 0" type="number" v-model.number="currentSettings.minValue" color="grey-9" label="Min value"/>
